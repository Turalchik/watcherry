...
class Command(BaseCommand):
    ...
    def movieToDirectorsAndWriters(self, filename):
        ...
        with open(f'{self.DATA_DIR}{filename}', newline='', encoding='utf-8') as crew_file:
    ...
    def movieToActorsAndProducers(self, filename):
        ...
        with open(f'{self.DATA_DIR}{filename}', newline='', encoding='utf-8') as principals_file:
    ...
    def movieToRating(self, filename):
        ...
        with open(f'{self.DATA_DIR}{filename}', newline='', encoding='utf-8') as ratings_file:
    ...
    def idToName(self, filename):
        ...
        with open(f'{self.DATA_DIR}{filename}', newline='', encoding='utf-8') as name_file:
    ...
    def handle(self, *args, **kwargs):
        ...
        with open(f'{self.DATA_DIR}title_basics_sample.tsv') as basics_file:
            basics_reader = csv.DictReader(basics_file, delimiter='\t')
            for row in basics_reader:
                if row['titleType'] == 'movie':
                    title = row['primaryTitle']
                    title_id = row['tconst']
                    rating = movie_to_rating[title_id]['averageRating'] if title_id in movie_to_rating else None
                    votes = movie_to_rating[title_id]['numVotes'] if title_id in movie_to_rating else None
